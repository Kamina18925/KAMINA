...
export const loginUser = async (req, res) => {
  ...
  try {
    ...
    if (!isPasswordValid) {
      ...
      if ((email === 'admin@barberiaRD.com' && password === '123456') ||
    (email === 'owner@barberiaRD.com' && password === '123456') ||
    (email === 'barber@barberiaRD.com' && password === '123456') ||
    (email === 'client@barberiaRD.com' && password === '123456')) {
